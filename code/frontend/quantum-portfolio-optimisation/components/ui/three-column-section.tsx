                        ...
                        {carousel.slides.map((slide, idx) => (
                            <SwiperSlide key={idx} className="w-[40vw]">
                                <div
                                    ...
                                    <div
                                        className="w-full h-40 bg-blue-950/20 rounded flex items-center justify-center">
                                        <span className="text-blue-400 text-sm">[ Image: {slide.image} ]</span>
                                    </div>
                                </div>
                            </SwiperSlide>
                        ))}
