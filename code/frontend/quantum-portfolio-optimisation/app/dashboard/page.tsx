...
export default function Dashboard() {
  ...
  const newPanel: LayoutPanelProps = {
    ...
    defaultSize: { w: 6, h: 4 },
    // If you have a "title" property for display, you can include it:
    // title: widgetTitle
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
            ...
            {panels.map((panel) => (
              ...
              >
                ...
                <p className="text-sm">
                  {panel.widgetType === "Cross chain swap"
                    ? "Cross Chain Swap Widget Content"
                    : "Widget Content Here"}
                </p>
              </div>
            ))}
            {/* END: Dynamic Widget Panels */}
          </div>
        </main>
